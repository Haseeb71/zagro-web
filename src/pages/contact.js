...
export default function Contact() {
  return (
    <Layout>
      <Head>
        <title>Contact Us - Zagro Footwear</title>
        <meta name="description" content="Get in touch with Zagro Footwear. Contact us via WhatsApp, email, or visit our store in Lahore." />
      </Head>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col items-center text-center">
                  ...
                  <a 
                    href="mailto:footwearzagro@gmail.com"
                    className="text-blue-600 hover:text-blue-700 font-medium transition-colors duration-300 break-all"
                  >
                    footwearzagro@gmail.com
                  </a>
                </div>
              </div>

              {/* Address */}
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-purple-700 font-medium">
                    Dubai Park Main G.T Road, Lahore
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 sm:p-8 border border-gray-200">
              ...
              <p className="text-gray-700 mb-4">
                We're here to help! Reach out to us through any of the contact methods above, and we'll get back to you as soon as possible.
              </p>
              <div className="space-y-2 text-gray-700">
                ...
                <p className="flex items-center">
                  ...
                  <span>For urgent inquiries, please use WhatsApp</span>
                </p>
              </div>
            </div>
          </div>
